...
# scape Session String
STRING_SESSION = os.environ.get("STRING_SESSION", None)

# Logging channel/group ID configuration.
BOTLOG_CHATID = int(os.environ.get("BOTLOG_CHATID", None))

# scape logging feature switch.
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/Calliope-K/Scape-Remix.git")
...
# set blacklist_chats where you do not want scape's features
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://i.ibb.co/HxjgDPm/Screenshot-20210119-134027.png"    
...
if STRING_SESSION:
    ...
    # pylint: disable=invalid-name
    bot = TelegramClient("scape", API_KEY, API_HASH)
...
async def check_botlog_chatid():
    if not BOTLOG_CHATID and LOGSPAMMER:
        ...
        LOGS.info(
            "You must set up the BOTLOG_CHATID variable in the config.env or environment variables, for the scape logging feature to work."
        )
        quit(1)
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("I'm [scape-remix](https://github.com/Calliope-K/Scape-Remix) modules helper...\nplease make your own bot, don't use mine 😋")
            else:
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "GitHub Repo",
                                "https://github.com/Calliope-K/Scape-Remix"),
                            custom.Button.url(
                                "Support",
