...
#
""" scape module for getting the date
    and time of any country or the scape server.  """
...
from scape import CMD_HELP, COUNTRY, TZ_NUMBER
...
async def time_func(tdata):
    """ For .time command, return the time of
        ...
        2. The default scape country(set it by using .settime),
        3. The server where the scape runs.
    """
