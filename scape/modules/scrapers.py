...
#
""" scape module containing various scrapers. """
...
from scape import CMD_HELP, BOTLOG, BOTLOG_CHATID, YOUTUBE_API_KEY, CHROME_DRIVER, GOOGLE_CHROME_BIN, bot, REM_BG_API_KEY, TEMP_DOWNLOAD_DIRECTORY, OCR_SPACE_API_KEY, LOGS
from scape.events import register
from telethon.tl.types import DocumentAttributeAudio
from scape.utils import progress, humanbytes, time_formatter, chrome, options, googleimagesdownload
import subprocess
...
TTS_LANG = "en"
TRT_LANG = "en"
TEMP_DOWNLOAD_DIRECTORY = "/root/scape/.bin"
...
async def carbon_api(e):
    ...
    await e.edit("`Processing..\n25%`")
    if os.path.isfile("/root/scape/.bin/carbon.png"):
        os.remove("/root/scape/.bin/carbon.png")
    ...
    prefs = {'download.default_directory': '/root/scape/.bin'}
    chrome_options.add_experimental_option('prefs', prefs)
    driver = webdriver.Chrome(executable_path=CHROME_DRIVER,
                              options=chrome_options)
    driver.get(url)
    await e.edit("`Processing..\n50%`")
    download_path = '/root/scape/.bin'
   ...
   # driver.find_element_by_xpath("//button[contains(text(),'PNG')]").click()
    ...
    while not os.path.isfile("/root/scape/.bin/carbon.png"):
        await sleep(0.5)
    await e.edit("`Processing..\n100%`")
    file = '/root/scape/.bin/carbon.png'
...
async def lang(value):
    """ For .lang command, change the default langauge of scape scrapers. """
