...
from scape import CMD_HELP, TEMP_DOWNLOAD_DIRECTORY
from scape.events import register
from scape.utils import chrome, human_to_bytes, humanbytes, md5, time_formatter
...
\nUsage: Download pixel experience ROM into your scape server.\
\n\n`.spec <brand> <device>`\
