...
""" scape module for having some fun with people. """
...
RUNS_STR = [
    ...
    "Running faster than Bolt coz i'mma scape !!",
    "Runs to Marie..",
...
async def univsaye(cowmsg):
    """ For .cowsay module, scape wrapper for cow which says things. """
...
async def react_meme(react):
    """ Make your scape react to everything. """
...
\n\n`.react`\
\nUsage: Make your scape react to everything.\
\n\n`.slap`\
