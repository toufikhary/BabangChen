# imported from catscape by @RoyalBoyPriyanshu and @DeletedUser420 also
...
from scape import bot, CMD_HELP
from scape import TEMP_DOWNLOAD_DIRECTORY
...
async def FakeGoogleSearch(event):
    ...
    blue=(0,0,255)
    black=(0,0,0)
    font1=ImageFont.truetype("scape/utils/styles/ProductSans-BoldItalic.ttf",20)
    font2=ImageFont.truetype("scape/utils/styles/ProductSans-Light.ttf",23)
