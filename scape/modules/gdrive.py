...
"""
    Google Drive manager for scape
"""
...
import scape.modules.sql_helper.google_drive_sql as helper
...
from scape.utils import progress, humanbytes, time_formatter, human_to_bytes
from scape.utils.exceptions import CancelProcess
from scape.modules.aria import aria2, check_metadata
# =========================================================== #
#                          STATIC                             #
# =========================================================== #
...
async def upload(gdrive, service, file_path, file_name, mimeType):
    ...
    body = {
        "name": file_name,
        "description": "Uploaded from Telegram using scape-remix scape.",
        "mimeType": mimeType,
    }
    try:
        if parent_Id is not None:
