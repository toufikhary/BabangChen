...
# you may not use this file except in compliance with the License.
 # thanks to anishsk 
"""
scape module to help you manage a group
"""
...
import html
import logging
import scape.modules.sql_helper.warns_sql as sql
from telethon import events, utils
from scape.utils.tools import is_admin
...
from scape import BOTLOG, BOTLOG_CHATID, CMD_HELP, bot
...
async def spider(spdr):
    ...
    try:
        from scape.modules.sql_helper.spam_mute_sql import mute
...
async def unmoot(unmot):
    ...
    # Check if the function running under SQL mode
    try:
        from scape.modules.sql_helper.spam_mute_sql import unmute
    except AttributeError:
...
async def muter(moot):
    ...
    try:
        from scape.modules.sql_helper.spam_mute_sql import is_muted
        from scape.modules.sql_helper.gmute_sql import is_gmuted
    except AttributeError:
        return
...
async def ungmoot(un_gmute):
    """ For .ungmute command, ungmutes the target in the scape """
    # Admin or creator check
    ...
    # Check if the function running under SQL mode
    try:
        from scape.modules.sql_helper.gmute_sql import ungmute
    except AttributeError:
...
async def gspider(gspdr):
    ...
    # Check if the function running under SQL mode
    try:
        from scape.modules.sql_helper.gmute_sql import gmute
    except AttributeError:
