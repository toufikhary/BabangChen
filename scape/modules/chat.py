...
""" scape module containing userid, chatid and log commands"""

from asyncio import sleep
from scape import CMD_HELP, BOTLOG, BOTLOG_CHATID, bot
...
from scape.modules.admin import get_user_from_event
...
async def unmute_chat(unm_e):
    ...
    try:
        from scape.modules.sql_helper.keep_read_sql import unkread
...
async def mute_chat(mute_e):
    ...
    try:
        from scape.modules.sql_helper.keep_read_sql import kread
    except AttributeError:
...
async def keep_read(message):
    """ The mute logic. """
    try:
        from scape.modules.sql_helper.keep_read_sql import is_kread
    except AttributeError:
        return
    kread = is_kread()
    if kread:
