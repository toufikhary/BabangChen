...
from scape import CMD_HELP, TEMP_DOWNLOAD_DIRECTORY, bot
from scape.events import register
from scape.utils.tools import check_media
...
async def draw_meme_text(image_path, text):
    ...
    m_font = ImageFont.truetype(
        "scape/utils/styles/MutantAcademyStyle.ttf", int((70 / 640) * i_width)
    )
    if ";" in text:
