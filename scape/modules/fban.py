...
async def fban(event):
    ...
    try:
        from scape.modules.sql_helper.fban_sql import get_flist
...
async def addf(event):
    ...
    try:
        from scape.modules.sql_helper.fban_sql import add_flist
    except IntegrityError:
        return await event.edit("**Running on Non-SQL mode!**")
...
async def delf(event):
    ...
    try:
        from scape.modules.sql_helper.fban_sql import del_flist
    except IntegrityError:
        return await event.edit("**Running on Non-SQL mode!**")
...
async def delf(event):
    ...
    try:
        from scape.modules.sql_helper.fban_sql import del_flist_all
    except IntegrityError:
        return await event.edit("**Running on Non-SQL mode!**")
