...
#
""" scape module for keeping control who PM's you, Logging pm and muting users in pm """
...
from scape.modules.sql_helper.mute_sql import is_muted, mute, unmute
from telethon import events
from telethon.tl import functions, types

from scape import (COUNT_PM, CMD_HELP, BOTLOG, BOTLOG_CHATID, PM_AUTO_BAN,
...
async def permitpm(event):
    ...
    if PM_AUTO_BAN:
        ...
        if event.is_private and event.chat_id != 777000 and event.chat_id != self_user.id and not (
            ...
            try:
                from scape.modules.sql_helper.pm_permit_sql import is_approved
                from scape.modules.sql_helper.globals import gvarstatus
...
async def auto_accept(event):
    ...
    if event.is_private and event.chat_id != 777000 and event.chat_id != self_user.id and not (
        ...
        try:
            from scape.modules.sql_helper.pm_permit_sql import is_approved
            from scape.modules.sql_helper.pm_permit_sql import approve
        except AttributeError:
            return
...
async def notifoff(noff_event):
    ...
    try:
        from scape.modules.sql_helper.globals import addgvar
    except AttributeError:
...
async def notifon(non_event):
    ...
    try:
        from scape.modules.sql_helper.globals import delgvar
    except AttributeError:
...
async def disapprovepm(disapprvpm):
    try:
        from scape.modules.sql_helper.pm_permit_sql import dissprove
...
#ignore, flexing tym 
#from scape.utils import admin_cmd
import io
import scape.modules.sql_helper.pm_permit_sql as pm_permit_sql
from telethon import events
