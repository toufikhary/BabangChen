...
#
""" scape module for changing your Telegram profile details+ now u can steal personal details of user. """
...
from scape import bot, CMD_HELP, TEMP_DOWNLOAD_DIRECTORY
