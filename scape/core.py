...
from scape.utils import command, remove_plugin, load_module
from var import Var
import importlib
from pathlib import Path
from scape import LOAD_PLUG
import sys
import asyncio
import traceback
import os
    ...
    if event.reply_to_msg_id:
        try:
            downloaded_file_name = await event.client.download_media(  # pylint:disable=E0602
                ...
                "scape/modules/"  # pylint:disable=E0602
            )
...
async def send(event):
    ...
    the_plugin_file = "./scape/modules/{}.py".format(input_str)
    start = datetime.now()
