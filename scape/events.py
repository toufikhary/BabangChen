...
"""scape module for managing events. One of the main components of the scape."""
...
from scape import bot, BOTLOG_CHATID, LOGSPAMMER
        ...
        async def wrapper(check):
            ...
            # spam chats
                ...
                if not disable_errors:
                    ...
                    ftext += "================================\n\n"
                    ftext += "--------BEGIN scape TRACEBACK LOG--------\n"
                    ftext += "\nDate: " + date
