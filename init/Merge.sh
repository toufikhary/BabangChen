...
cd
git clone https://github.com/Calliope-K/Scape-Remix.git
cd oub-remix
git remote set-url origin https://${GH_USERNAME}:${GH_PERSONAL_TOKEN}@github.com/Calliope-K/Scape-Remix.git
git fetch
